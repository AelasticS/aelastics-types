...
export namespace types {
  ...
  export type TraversalFunc = tc.TraversalFunc
  ...
  export const isObjectType = (v: any): v is cot.ObjectTypeC<any, any> =>
    v instanceof cot.ObjectTypeC

  export type DtoObjectType<T extends cot.Props> = cot.DtoObjectType<T>

  export type ArrayType<T extends ct.Any> = cat.ArrayTypeC<T>
  export const isArrayType = (v: any): v is cat.ArrayTypeC<any> => v instanceof cat.ArrayTypeC

  export type ComplexType<P, T extends any, D extends any = T> = cct.ComplexTypeC<T, D>
  export const isComplexType = (v: any): v is cct.ComplexTypeC<any, any> =>
    v instanceof cct.ComplexTypeC

  export type FunctionalType<P extends cot.Props, R extends Any> = cft.FunctionalTypeC<P, R>
  export const isFunctionalType = (v: any): v is cft.FunctionalTypeC<any, any> =>
    v instanceof cft.FunctionalTypeC

  export type IntersectionType<P extends Array<Any>> = cit.IntersectionTypeC<P>
  export const isIntersectionType = (v: any): v is cit.IntersectionTypeC<any> =>
    v instanceof cit.IntersectionTypeC

  export type MapType<K extends Any, V extends Any> = cmt.MapTypeC<K, V>
  export const isMapType = (v: any): v is cmt.MapTypeC<any, any> => v instanceof cmt.MapTypeC

  export type EntityReference<
    T extends cot.ObjectTypeC<any, readonly string[]>
  > = cort.EntityReference<T>
  export const isEntityReference = (v: any): v is cort.EntityReference<any> =>
    v instanceof cort.EntityReference
  ...
  > = cst.SubtypeC<P, SP, S>
  export const isSubtype = (v: any): v is cst.SubtypeC<any, any, any> => v instanceof cst.SubtypeC

  export type TaggedUnionType<P extends cot.Props> = ctut.TaggedUnionTypeC<P>
  export const isTaggedUnionType = (v: any): v is ctut.TaggedUnionTypeC<any> =>
    v instanceof ctut.TaggedUnionTypeC

  export type UnionType<P extends Any[]> = cut.UnionTypeC<P>
  export const isUnionType = (v: any): v is cut.UnionTypeC<any> => v instanceof cut.UnionTypeC

  export type SimpleType<T> = st.SimpleTypeC<T>
  export const isSimpleType = (v: any): v is st.SimpleTypeC<any> => v instanceof st.SimpleTypeC

  export type OptionalType<T extends Any> = sto.OptionalTypeC<T>
  export const isOptionalType = (v: any): v is sto.OptionalTypeC<any> =>
    v instanceof sto.OptionalTypeC
  ...
  export const isTypeSchema = (v: any): v is schema.TypeSchema => v instanceof schema.TypeSchema

  export type LinkType = link.LinkC
  export const isLinkType = (v: any): v is link.LinkC => v instanceof link.LinkC
}
